...
local emb_dim = 50
local model_class, model_structure = vqalstm.LSTMVQATO, args.model
...
---------- Save model ----------
local model_save_path = string.format("./done/vqalstm_textonly-%s.l%d.d%d.e%d.c%d-%s.t7", args.model, args.layers, args.dim, best_dev_epoch, args.cuda and 1 or 0, os.date('%Y-%m-%dT%H%M%S'))
