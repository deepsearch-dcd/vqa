...
trainset.images = train_utils.lookup(trainset.images, features)
testset.images = train_utils.lookup(testset.images, features)

model = model:cuda()
local criterion = nn.ClassNLLCriterion():cuda()
train_utils.to_cuda(trainset)
train_utils.to_cuda(testset)
